...
def left(landmarks):
    ...
    knee_angle = angle_cal(hip, knee, ankle)
    
    if knee_angle >=100:
        knee_color = (20,255,57)
    else:
        knee_color = (255,0,0)
    ...
    if hip_angle >=120:
        ...
        hip_color = (255,0,0)
    return [[knee,knee_angle,knee_color],[hip,hip_angle,hip_color]]
...
#         image, blank_image = free_squats(frame,pose)
